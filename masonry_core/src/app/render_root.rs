...
impl RenderRoot {
    ...
    // --- MARK: ACCESS WIDGETS
    /// Get a [`WidgetRef`] to the root widget of the given [layer](crate::doc::masonry_concepts#layers).
    ...
    /// Get a [`WidgetMut`] to the root widget of the given [layer](crate::doc::masonry_concepts#layers).
    ///
    /// Because of how `WidgetMut` works, it can only be passed to a user-provided callback.
    ///
    /// # Panics
