...
impl_context_method!(
    ...
    AccessCtx<'_>,
    {
        ...
        fn get_child_state<Child: Widget + ?Sized>(
            &self,
            child: &'_ WidgetPod<Child>,
        ) -> &'_ WidgetState {
...
impl MutateCtx<'_> {
    ...
    pub fn get_mut<'c, Child: Widget + FromDynWidget + ?Sized>(
        ...
        WidgetMut {
            ...
            widget: Child::from_dyn_mut2(child_mut.item).unwrap(),
        }
    }
...
impl LayoutCtx<'_> {
    ...
    /// the child.
    #[track_caller]
    pub fn place_child<W: Widget + ?Sized>(&mut self, child: &mut WidgetPod<W>, origin: Point) {
