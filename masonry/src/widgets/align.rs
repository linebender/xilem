...
mod tests {
    ...
    #[test]
    fn centered() {
        let widget = Align::centered(Label::new("hello").with_next_id());
    ...
    #[test]
    fn right() {
        let widget = Align::right(Label::new("hello").with_next_id());
    ...
    #[test]
    fn left() {
        let widget = Align::left(Label::new("hello").with_next_id());
