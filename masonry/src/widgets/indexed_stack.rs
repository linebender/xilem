...
mod tests {
    ...
    fn test_widget_removal_and_modification() {
        let widget = IndexedStack::new()
            .with_child(Button::new(Label::new("A").with_auto_id()).with_auto_id())
            .with_child(Button::new(Label::new("B").with_auto_id()).with_auto_id())
            .with_child(Button::new(Label::new("C").with_auto_id()).with_auto_id())
            .with_active_child(1)
            .with_auto_id();
        let window_size = Size::new(50.0, 50.0);
        let mut harness =
