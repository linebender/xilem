...
mod views;
pub use views::{
    memoize, Memoize, OneOf2, OneOf2Ctx, OneOf3, OneOf3Ctx, OneOf4, OneOf4Ctx, OneOf5, OneOf5Ctx,
    OneOf6, OneOf6Ctx, OneOf7, OneOf7Ctx, OneOf8, OneOf8Ctx, OneOf9, OneOf9Ctx,
};
