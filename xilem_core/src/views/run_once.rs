...
///
/// ```
/// # use xilem_core::{run_once, View, docs::{Fake as ViewCtx}};
/// # struct AppData;
/// fn log_lifecycle(data: &mut AppData) -> impl View<AppData, (), ViewCtx> {
...
/// #    data: u32
/// # }
/// fn log_data(app: &mut AppData) -> impl View<AppData, (), ViewCtx> {
///     let val = app.data;
