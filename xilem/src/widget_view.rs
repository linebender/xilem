...
use xilem_core::{View, ViewSequence};

use crate::any_view::AnyWidgetView;
...
pub trait WidgetViewSequence<State, Action = ()>:
    ViewSequence<State, Action, ViewCtx, Pod<crate::any_view::DynWidget>>
{
}

impl<Seq, State, Action> WidgetViewSequence<State, Action> for Seq where
    Seq: ViewSequence<State, Action, ViewCtx, Pod<crate::any_view::DynWidget>>
{
}
