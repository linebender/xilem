...
use xilem::{Color, EventLoop, EventLoopBuilder, WidgetView, WindowAttrs, Xilem, palette};
...
fn run(event_loop: EventLoopBuilder) -> Result<(), EventLoopError> {
    ...
    let window_attributes = WindowAttrs::new("Calculator").with_min_inner_size(min_window_size);
    ...
    let window_attributes = window_attributes.with_initial_inner_size(window_size);
    let app = Xilem::new_simple(data, app_logic, window_attributes);
