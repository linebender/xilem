...
use xilem::{
    EventLoop, EventLoopBuilder, LineBreaking, TextAlignment, WidgetView, WindowAttrs, Xilem,
    palette,
};
...
fn run(event_loop: EventLoopBuilder) -> Result<(), EventLoopError> {
    ...
    let app = Xilem::new_simple(
        data,
        VirtualCats::view,
        WindowAttrs::new("Virtualised HTTP cats").with_min_inner_size(LogicalSize::new(200., 200.)),
    );
