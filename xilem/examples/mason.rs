...
use xilem::{
    EventLoop, EventLoopBuilder, FontWeight, InsertNewline, TextAlignment, WidgetView, WindowAttrs,
    Xilem, palette,
};
...
fn run(event_loop: EventLoopBuilder) -> Result<(), EventLoopError> {
    ...
    Xilem::new_simple(data, app_logic, WindowAttrs::new("mason")).run_in(event_loop)
}
