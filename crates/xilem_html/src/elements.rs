...
define_elements!(
    ...
    (SVG_NS, AnimateMotion, animate_motion, SvgAnimateMotionElement, "animateMotion", T, A, VS),
    (SVG_NS, AnimateTransform, animate_transform, SvgAnimateTransformElement, "animateTransform", T, A, VS),
    (SVG_NS, Circle, circle, SvgCircleElement),
    (SVG_NS, ClipPath, clip_path, SvgClipPathElement, "clipPath", T, A, VS),
    (SVG_NS, Defs, defs, SvgDefsElement),
    (SVG_NS, Desc, desc, SvgDescElement),
    (SVG_NS, Ellipse, ellipse, SvgEllipseElement),
    (SVG_NS, FeBlend, fe_blend, SvgfeBlendElement, "feBlend", T, A, VS),
    (SVG_NS, FeColorMatrix, fe_color_matrix, SvgfeColorMatrixElement, "feColorMatrix", T, A, VS),
    (SVG_NS, FeComponentTransfer, fe_component_transfer, SvgfeComponentTransferElement, "feComponentTransfer", T, A, VS),
    (SVG_NS, FeComposite, fe_composite, SvgfeCompositeElement, "feComposite", T, A, VS),
    (SVG_NS, FeConvolveMatrix, fe_convolve_matrix, SvgfeConvolveMatrixElement, "feConvolveMatrix", T, A, VS),
    (SVG_NS, FeDiffuseLighting, fe_diffuse_lighting, SvgfeDiffuseLightingElement, "feDiffuseLighting", T, A, VS),
    (SVG_NS, FeDisplacementMap, fe_displacement_map, SvgfeDisplacementMapElement, "feDisplacementMap", T, A, VS),
    (SVG_NS, FeDistantLight, fe_distant_light, SvgfeDistantLightElement, "feDistantLight", T, A, VS),
    (SVG_NS, FeDropShadow, fe_drop_shadow, SvgfeDropShadowElement, "feDropShadow", T, A, VS),
    (SVG_NS, FeFlood, fe_flood, SvgfeFloodElement, "feFlood", T, A, VS),
    (SVG_NS, FeFuncA, fe_func_a, SvgfeFuncAElement, "feFuncA", T, A, VS),
    (SVG_NS, FeFuncB, fe_func_b, SvgfeFuncBElement, "feFuncB", T, A, VS),
    (SVG_NS, FeFuncG, fe_func_g, SvgfeFuncGElement, "feFuncG", T, A, VS),
    (SVG_NS, FeFuncR, fe_func_r, SvgfeFuncRElement, "feFuncR", T, A, VS),
    (SVG_NS, FeGaussianBlur, fe_gaussian_blur, SvgfeGaussianBlurElement, "feGaussianBlur", T, A, VS),
    (SVG_NS, FeImage, fe_image, SvgfeImageElement, "feImage", T, A, VS),
    (SVG_NS, FeMerge, fe_merge, SvgfeMergeElement, "feMerge", T, A, VS),
    (SVG_NS, FeMergeNode, fe_merge_node, SvgfeMergeNodeElement, "feMergeNode", T, A, VS),
    (SVG_NS, FeMorphology, fe_morphology, SvgfeMorphologyElement, "feMorphology", T, A, VS),
    (SVG_NS, FeOffset, fe_offset, SvgfeOffsetElement, "feOffset", T, A, VS),
    (SVG_NS, FePointLight, fe_point_light, SvgfePointLightElement, "fePointLight", T, A, VS),
    (SVG_NS, FeSpecularLighting, fe_specular_lighting, SvgfeSpecularLightingElement, "feSpecularLighting", T, A, VS),
    (SVG_NS, FeSpotLight, fe_spot_light, SvgfeSpotLightElement, "feSpotLight", T, A, VS),
    (SVG_NS, FeTile, fe_tile, SvgfeTileElement, "feTile", T, A, VS),
    (SVG_NS, FeTurbulence, fe_turbulence, SvgfeTurbulenceElement, "feTurbulence", T, A, VS),
    (SVG_NS, Filter, filter, SvgFilterElement),
    (SVG_NS, ForeignObject, foreign_object, SvgForeignObjectElement, "foreignObject", T, A, VS),
    ...
    (SVG_NS, LinearGradient, linear_gradient, SvgLinearGradientElement, "linearGradient", T, A, VS),
    ...
    (SVG_NS, RadialGradient, radial_gradient, SvgRadialGradientElement, "radialGradient", T, A, VS),
    ...
    (SVG_NS, TextPath, text_path, SvgTextPathElement, "textPath", T, A, VS),
